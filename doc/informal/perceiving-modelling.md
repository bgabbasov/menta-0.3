...
See [Ways to think](http://web.media.mit.edu/~minsky/E7/eb7.html#_Toc451324833)
 ...
 1. EmotionMachine runs:
   ...
   [Goal](https://github.com/menta/menta-0.3/raw/master/doc/design-specification/uml/images/GoalConceptClass.png): Help user.
   2. Reflective Critics selects and starts ProblemSolving [Way2Think](way2Think.md) with
   [Goal](https://github.com/menta/menta-0.3/raw/master/doc/design-specification/uml/images/GoalConceptClass.png): ResolveIncident.
   ...
   2. KnowingHow(Perceiving) Way2Think:
     ...
     instance from CurrentSituation model.
         4. DesiredState if not mentioned explicitly could be inferred as following:
             5. System has a [goal](https://github.com/menta/menta-0.3/raw/master/doc/design-specification/uml/images/GoalConceptClass.png) to help User.
